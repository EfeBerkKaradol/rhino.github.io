...
const ARViewer = ({
  ...
  const startCamera = useCallback(async () => {
    ...
    try {
      ...
      setError(
        "Kamera erişimi başarısız. Lütfen kamera izinlerini kontrol edin."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const setupThreeScene = useCallback(async () => {
    ...
    // Basit model (ShapeDiver entegrasyonu için geliştirilebilir)
  ...
  // AR modu başlatıldığında sahneyi kur
  useEffect(() => {
